...
claude_agent_compose_file_has_expected_content() {
	...
	assert_proxy_service "$compose_file" "ghcr.io/WiIIManidis/agent-sandbox-proxy@sha256:abc123"
	assert_agent_service_base "$compose_file" "ghcr.io/WiIIManidis/agent-sandbox-claude@sha256:def456"
...
copilot_agent_compose_file_has_expected_content() {
	...
	assert_proxy_service "$compose_file" "ghcr.io/WiIIManidis/agent-sandbox-proxy@sha256:abc123"
	assert_agent_service_base "$compose_file" "ghcr.io/WiIIManidis/agent-sandbox-copilot@sha256:ghi789"
	assert_common_environment_vars "$compose_file"
	assert_common_volumes "$compose_file"
...
@test "cli creates docker-compose.yml for claude agent with all options enabled" {
	export AGENTBOX_PROXY_IMAGE="ghcr.io/WiIIManidis/agent-sandbox-proxy:latest"
	export AGENTBOX_AGENT_IMAGE="ghcr.io/WiIIManidis/agent-sandbox-claude:latest"
	...
	stub pull_and_pin_image \
		"ghcr.io/WiIIManidis/agent-sandbox-proxy:latest : echo 'ghcr.io/WiIIManidis/agent-sandbox-proxy@sha256:abc123'" \
		"ghcr.io/WiIIManidis/agent-sandbox-claude:latest : echo 'ghcr.io/WiIIManidis/agent-sandbox-claude@sha256:def456'"
...
@test "cli creates docker-compose.yml for copilot agent with all options enabled" {
	export AGENTBOX_PROXY_IMAGE="ghcr.io/WiIIManidis/agent-sandbox-proxy:latest"
	export AGENTBOX_AGENT_IMAGE="ghcr.io/WiIIManidis/agent-sandbox-copilot:latest"
	export AGENTBOX_ENABLE_SHELL_CUSTOMIZATIONS="true"
	export AGENTBOX_ENABLE_DOTFILES="true"
	export AGENTBOX_MOUNT_GIT_READONLY="true"
	export AGENTBOX_MOUNT_IDEA_READONLY="true"
	...
	stub pull_and_pin_image \
		"ghcr.io/WiIIManidis/agent-sandbox-proxy:latest : echo 'ghcr.io/WiIIManidis/agent-sandbox-proxy@sha256:abc123'" \
		"ghcr.io/WiIIManidis/agent-sandbox-copilot:latest : echo 'ghcr.io/WiIIManidis/agent-sandbox-copilot@sha256:ghi789'"
