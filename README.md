...
```bash
# Clone the repo
git clone https://github.com/WiIIManidis/agent-sandbox.git
...
docker pull ghcr.io/WiIIManidis/agent-sandbox-cli

# Add to your .bashrc or .zshrc
alias agentbox='docker run --rm -it -v "/var/run/docker.sock:/var/run/docker.sock" -v"$PWD:$PWD" -w"$PWD" -e TERM -e HOME --network none ghcr.io/WiIIManidis/agent-sandbox-cli'
```
